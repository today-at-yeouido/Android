...
import com.todayeouido.tayapp.data.remote.Constants.GET_AUTOCOMPLETE
import com.todayeouido.tayapp.data.remote.Constants.GET_BILL_DETAIL
import com.todayeouido.tayapp.data.remote.Constants.GET_BILL_GROUP
import com.todayeouido.tayapp.data.remote.Constants.GET_BILL_HOME
import com.todayeouido.tayapp.data.remote.Constants.GET_BILL_HOME_COMMITTEE
import com.todayeouido.tayapp.data.remote.Constants.GET_BILL_MOST_VIEWED
import com.todayeouido.tayapp.data.remote.Constants.GET_BILL_RECENT
import com.todayeouido.tayapp.data.remote.Constants.GET_BILL_SCRAP
import com.todayeouido.tayapp.data.remote.Constants.GET_BILL_SEARCH
import com.todayeouido.tayapp.data.remote.Constants.GET_BILL_USER_RECENT_VIEWED
import com.todayeouido.tayapp.data.remote.Constants.GET_BILL_USER_RECOMMENDED
import com.todayeouido.tayapp.data.remote.Constants.GET_RECCOMEND_SEARCH
import com.todayeouido.tayapp.data.remote.Constants.POST_ADD_SCRAP
import com.todayeouido.tayapp.data.remote.Constants.POST_DELETE_SCRAP
import com.todayeouido.tayapp.data.remote.dto.RecommendSearchDto
import com.todayeouido.tayapp.data.remote.dto.bill.*
import com.todayeouido.tayapp.data.remote.dto.scrap.*
